namespace FakeMG.TimeCycle
{
    ...
    internal sealed class TimeOfCycleConfigurationSession
    {
        ...
        public bool TrySetContextOverride(TimeOfCycleOverrideSO contextOverrideSO, out CyclePeriodChange? periodChange, out string errorMessage)
        {
        ...
        public bool TrySetRuntimeOverride(TimeOfCycleOverrideSO runtimeOverrideSO, out CyclePeriodChange? periodChange, out string errorMessage)
        {
            ...
            out string errorMessage)
        {
            ...
            double authoritativeProgress01 = _clock.AuthoritativeTimeSeconds / CurrentConfiguration.CycleDurationSeconds;
