namespace FakeMG.TimeCycle
{
    ...
    public sealed class TimeControlRequest
    {
        ...
        public static TimeControlRequest Create(ITimeControlStrategy strategy, int priority, bool allowsTimeCommands)
        {
        ...
        public static TimeControlRequest ProvideAuthoritativeTime(ITimeOfCycleTimeProvider timeProvider, int priority, bool allowsTimeCommands)
        {
            return new TimeControlRequest(priority, allowsTimeCommands, 0d, timeProvider, new ProvidedTimeControlStrategy(timeProvider));
        }
