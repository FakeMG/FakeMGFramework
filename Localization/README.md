...
### ⏳ Planned (To-Do)
- Drop down to select localization key: Used in ScriptableObject to select localization key instead of calling the generated code directly. (Cause writing different code for different SO is tedious)
