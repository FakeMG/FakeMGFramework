...
namespace FakeMG.FakeMGFramework.Editor.SceneSwitcher {
    public class SceneSwitcherWindow : EditorWindow {
        ...
        private void OnGUI() {
            ...
            EditorGUILayout.Space();
            EditorGUILayout.HelpBox("Use Shift + number keys (1-9) to quickly switch between assigned scenes.", MessageType.Info);
        }
        ...
        public static void SwitchScene1() { SwitchToSceneByIndex(0); }
        
        [MenuItem(MENU_PATH + "/Switch Scene 2 _#2")]
        public static void SwitchScene2() { SwitchToSceneByIndex(1); }
        
        [MenuItem(MENU_PATH + "/Switch Scene 3 _#3")]
        public static void SwitchScene3() { SwitchToSceneByIndex(2); }
        
        [MenuItem(MENU_PATH + "/Switch Scene 4 _#4")]
        public static void SwitchScene4() { SwitchToSceneByIndex(3); }
        
        [MenuItem(MENU_PATH + "/Switch Scene 5 _#5")]
        public static void SwitchScene5() { SwitchToSceneByIndex(4); }
        
        [MenuItem(MENU_PATH + "/Switch Scene 6 _#6")]
        public static void SwitchScene6() { SwitchToSceneByIndex(5); }
        
        [MenuItem(MENU_PATH + "/Switch Scene 7 _#7")]
        public static void SwitchScene7() { SwitchToSceneByIndex(6); }
        
        [MenuItem(MENU_PATH + "/Switch Scene 8 _#8")]
        public static void SwitchScene8() { SwitchToSceneByIndex(7); }
        
        [MenuItem(MENU_PATH + "/Switch Scene 9 _#9")]
        public static void SwitchScene9() { SwitchToSceneByIndex(8); }
