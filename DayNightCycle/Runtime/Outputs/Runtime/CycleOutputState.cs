...
namespace FakeMG.DayNightCycle
{
    ...
    internal sealed class CycleOutputState : IReadOnlyCycleOutputState
    {
        ...
        public bool TryGetValue(RotationCycleOutputKeySO outputKeySO, out UnityEngine.Quaternion value)
        {
            return TryGetTypedValue(outputKeySO, out value);
        }
        ...
        {
            if (_valueByOutputKey.TryGetValue(outputKeySO, out object untypedValue) && untypedValue is T typedValue)
            {
                value = typedValue;
                return true;
            }
