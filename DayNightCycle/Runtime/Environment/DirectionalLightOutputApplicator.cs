...
namespace FakeMG.DayNightCycle
{
    ...
    public sealed class DirectionalLightOutputApplicator : MonoBehaviour, ITimeOfCycleOutputApplicator
    {
        ...
        public void Apply(IReadOnlyCycleOutputState outputState)
        {
            ...
            if (outputState.TryGetValue(_outputSchemaSO.MainLightShadowStrength, out float shadowStrength01))
            {
...
#if UNITY_EDITOR
        public void ConfigureForEditor(Light directionalLight, DayNightEnvironmentOutputSchemaSO outputSchemaSO)
        {
