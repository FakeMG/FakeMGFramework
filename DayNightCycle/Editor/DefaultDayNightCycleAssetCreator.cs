...
namespace FakeMG.DayNightCycle.Editor
{
    ...
    {
        private const string FEATURE_ROOT_PATH = "Assets/Thirdparty/FakeMGFramework/DayNightCycle";
        ...
        private const double DAWN_START_PROGRESS_01 = 18000d / CYCLE_DURATION_SECONDS;
        private const double DAY_START_PROGRESS_01 = 25200d / CYCLE_DURATION_SECONDS;
        private const double DUSK_START_PROGRESS_01 = 64800d / CYCLE_DURATION_SECONDS;
        private const double NIGHT_START_PROGRESS_01 = 72000d / CYCLE_DURATION_SECONDS;
        ...
        private static bool TryPreflight(out Shader proceduralSkyShader, out string errorMessage)
        {
            ...
            for (int requirementIndex = 0; requirementIndex < requirements.Length; requirementIndex++)
            {
                ...
                if (existingAsset == null || requirements[requirementIndex].ExpectedType.IsInstanceOfType(existingAsset))
                {
                    continue;
                }
        ...
        {
            DayNightEnvironmentOutputSchemaSO outputSchemaSO = AssetDatabase.LoadAssetAtPath<DayNightEnvironmentOutputSchemaSO>(OUTPUT_SCHEMA_PATH);
        ...
        private static TimeOfCycleProfileSO CreateOrUpdateProfile(DayNightEnvironmentOutputSchemaSO outputSchemaSO)
        {
            TimeOfCycleProfileSO profileSO = AssetDatabase.LoadAssetAtPath<TimeOfCycleProfileSO>(PROFILE_PATH);
            if (profileSO == null)
            {
        ...
        {
            AnimationCurve smoothCurve = AnimationCurve.Linear(0f, 0f, 1f, 1f);
            List<CycleOutputDefinition> outputs = new()
            {
                ...
                new RotationCycleOutputDefinition(
                    ...
                    new[]
                    {
                        ...
                        new RotationCyclePoint(21600d / CYCLE_DURATION_SECONDS, new Vector3(0f, 330f, 0f)),
                        new RotationCyclePoint(43200d / CYCLE_DURATION_SECONDS, new Vector3(90f, 330f, 0f)),
                        new RotationCyclePoint(64800d / CYCLE_DURATION_SECONDS, new Vector3(180f, 330f, 0f)),
                    }
                ),
                CreateColorOutput(
                    outputSchemaSO.MainLightColor,
                    new ColorCyclePoint(0d, new Color(0.28f, 0.36f, 0.62f)),
                    new ColorCyclePoint(19800d / CYCLE_DURATION_SECONDS, new Color(1f, 0.55f, 0.32f)),
                    new ColorCyclePoint(DAY_START_PROGRESS_01, new Color(1f, 0.96f, 0.84f)),
                    new ColorCyclePoint(DUSK_START_PROGRESS_01, new Color(1f, 0.42f, 0.2f)),
                    new ColorCyclePoint(NIGHT_START_PROGRESS_01, new Color(0.28f, 0.36f, 0.62f))
                ),
                CreateFloatOutput(
                    outputSchemaSO.MainLightIntensity,
                    new FloatCyclePoint(0d, 0.04f),
                    new FloatCyclePoint(DAWN_START_PROGRESS_01, 0.15f),
                    new FloatCyclePoint(DAY_START_PROGRESS_01, 1f),
                    new FloatCyclePoint(DUSK_START_PROGRESS_01, 0.25f),
                    new FloatCyclePoint(NIGHT_START_PROGRESS_01, 0.04f)
                ),
                CreateFloatOutput(
                    outputSchemaSO.MainLightShadowStrength,
                    new FloatCyclePoint(0d, 0.1f),
                    new FloatCyclePoint(DAY_START_PROGRESS_01, 0.85f),
                    new FloatCyclePoint(DUSK_START_PROGRESS_01, 0.45f),
                    new FloatCyclePoint(NIGHT_START_PROGRESS_01, 0.1f)
                ),
                CreateConstantIntOutput(outputSchemaSO.SkySunDisk, 2),
                CreateFloatOutput(
                    outputSchemaSO.SkySunSize,
                    new FloatCyclePoint(0d, 0.025f),
                    new FloatCyclePoint(DAWN_START_PROGRESS_01, 0.06f),
                    new FloatCyclePoint(DAY_START_PROGRESS_01, 0.04f),
                    new FloatCyclePoint(DUSK_START_PROGRESS_01, 0.065f),
                    new FloatCyclePoint(NIGHT_START_PROGRESS_01, 0.025f)
                ),
                ...
                CreateFloatOutput(
                    ...
                    new FloatCyclePoint(DAWN_START_PROGRESS_01, 1.3f),
                    new FloatCyclePoint(DAY_START_PROGRESS_01, 0.9f),
                    new FloatCyclePoint(DUSK_START_PROGRESS_01, 1.45f),
                    new FloatCyclePoint(NIGHT_START_PROGRESS_01, 0.35f)
                ),
                CreateColorOutput(
                    outputSchemaSO.SkyTint,
                    new ColorCyclePoint(0d, new Color(0.08f, 0.12f, 0.28f)),
                    new ColorCyclePoint(DAWN_START_PROGRESS_01, new Color(0.78f, 0.42f, 0.38f)),
                    new ColorCyclePoint(DAY_START_PROGRESS_01, new Color(0.45f, 0.62f, 0.9f)),
                    new ColorCyclePoint(DUSK_START_PROGRESS_01, new Color(0.82f, 0.32f, 0.28f)),
                    new ColorCyclePoint(NIGHT_START_PROGRESS_01, new Color(0.08f, 0.12f, 0.28f))
                ),
                CreateColorOutput(
                    outputSchemaSO.SkyGroundColor,
                    new ColorCyclePoint(0d, new Color(0.03f, 0.04f, 0.08f)),
                    new ColorCyclePoint(DAWN_START_PROGRESS_01, new Color(0.32f, 0.16f, 0.12f)),
                    new ColorCyclePoint(DAY_START_PROGRESS_01, new Color(0.34f, 0.32f, 0.28f)),
                    new ColorCyclePoint(DUSK_START_PROGRESS_01, new Color(0.28f, 0.12f, 0.09f)),
                    new ColorCyclePoint(NIGHT_START_PROGRESS_01, new Color(0.03f, 0.04f, 0.08f))
                ),
                CreateFloatOutput(
                    outputSchemaSO.SkyExposure,
                    new FloatCyclePoint(0d, 0.35f),
                    new FloatCyclePoint(DAWN_START_PROGRESS_01, 0.75f),
                    new FloatCyclePoint(DAY_START_PROGRESS_01, 1.25f),
                    new FloatCyclePoint(DUSK_START_PROGRESS_01, 0.7f),
                    new FloatCyclePoint(NIGHT_START_PROGRESS_01, 0.35f)
                ),
                ...
                CreateColorOutput(
                    ...
                    new ColorCyclePoint(DAWN_START_PROGRESS_01, new Color(0.48f, 0.3f, 0.28f)),
                    new ColorCyclePoint(DAY_START_PROGRESS_01, new Color(0.62f, 0.72f, 0.82f)),
                    new ColorCyclePoint(DUSK_START_PROGRESS_01, new Color(0.48f, 0.24f, 0.22f)),
                    new ColorCyclePoint(NIGHT_START_PROGRESS_01, new Color(0.055f, 0.07f, 0.14f))
                ),
                CreateFloatOutput(
                    outputSchemaSO.FogDensity,
                    new FloatCyclePoint(0d, 0.008f),
                    new FloatCyclePoint(DAY_START_PROGRESS_01, 0.002f),
                    new FloatCyclePoint(DUSK_START_PROGRESS_01, 0.004f),
                    new FloatCyclePoint(NIGHT_START_PROGRESS_01, 0.008f)
                ),
                ...
                CreateFloatOutput(
                    ...
                    new FloatCyclePoint(DAY_START_PROGRESS_01, 1f),
                    new FloatCyclePoint(DUSK_START_PROGRESS_01, 0.55f),
                    new FloatCyclePoint(NIGHT_START_PROGRESS_01, 0.28f)
                ),
                ...
                CreateColorOutput(
                    ...
                    new ColorCyclePoint(DAY_START_PROGRESS_01, new Color(0.48f, 0.62f, 0.82f)),
                    new ColorCyclePoint(DUSK_START_PROGRESS_01, new Color(0.5f, 0.24f, 0.22f)),
                    new ColorCyclePoint(NIGHT_START_PROGRESS_01, new Color(0.035f, 0.055f, 0.14f))
                ),
                CreateColorOutput(
                    outputSchemaSO.AmbientEquatorColor,
                    new ColorCyclePoint(0d, new Color(0.025f, 0.035f, 0.07f)),
                    new ColorCyclePoint(DAY_START_PROGRESS_01, new Color(0.34f, 0.4f, 0.46f)),
                    new ColorCyclePoint(DUSK_START_PROGRESS_01, new Color(0.32f, 0.16f, 0.13f)),
                    new ColorCyclePoint(NIGHT_START_PROGRESS_01, new Color(0.025f, 0.035f, 0.07f))
                ),
                CreateColorOutput(
                    outputSchemaSO.AmbientGroundColor,
                    new ColorCyclePoint(0d, new Color(0.012f, 0.014f, 0.025f)),
                    new ColorCyclePoint(DAY_START_PROGRESS_01, new Color(0.16f, 0.15f, 0.13f)),
                    new ColorCyclePoint(DUSK_START_PROGRESS_01, new Color(0.12f, 0.07f, 0.06f)),
                    new ColorCyclePoint(NIGHT_START_PROGRESS_01, new Color(0.012f, 0.014f, 0.025f))
                ),
            };
        ...
        private static CycleOutputDefinition CreateMainLightEnabledOutput(DayNightEnvironmentOutputSchemaSO outputSchemaSO)
        {
            return CreateConstantBoolOutput(outputSchemaSO.MainLightEnabled, true);
        }

        private static CycleOutputDefinition CreateConstantBoolOutput(BoolCycleOutputKeySO outputKeySO, bool value)
        {
        ...
        private static CycleOutputDefinition CreateConstantIntOutput(IntCycleOutputKeySO outputKeySO, int value)
        {
        ...
        private static CycleOutputDefinition CreateConstantFloatOutput(FloatCycleOutputKeySO outputKeySO, float value)
        {
            return CreateFloatOutput(outputKeySO, new FloatCyclePoint(0d, value));
        }

        private static CycleOutputDefinition CreateFloatOutput(FloatCycleOutputKeySO outputKeySO, params FloatCyclePoint[] points)
        {
        ...
        {
            return new ColorCycleOutputDefinition(outputKeySO, PROFILE_TRANSITION_DURATION_SECONDS, AnimationCurve.EaseInOut(0f, 0f, 1f, 1f), points);
        }
        ...
        )
        {
            ...
            try
            {
                ...
                AmbientRenderSettingsOutputApplicator ambientApplicator = root.AddComponent<AmbientRenderSettingsOutputApplicator>();
                ...
                DirectionalLightOutputApplicator lightApplicator = sunObject.AddComponent<DirectionalLightOutputApplicator>();
